...
const Dashboard = () => {
  ...
  const hasProfile =
    fitnessProfile?.age && fitnessProfile?.weight && fitnessProfile?.height;
  ...
  const stats = [
    { label: "Workouts Generated", value: 0, icon: Dumbbell },
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 pt-24 pb-12">
        ...
        {hasProfile ? (
          ...
          <Link
            to="/profile"
            className="glass-card p-6 mb-8 flex items-center gap-4 hover:border-primary/30 transition-all group block"
          >
            ...
            <div className="flex items-center gap-8">
              <div className="flex-1">
                ...
                <div className="w-full h-3 rounded-full bg-secondary overflow-hidden">
                  <div
                    className="h-full rounded-full bg-gradient-to-r from-blue-400 via-primary to-orange-400"
